...
public sealed class ChallengeSourceTests {
    ...
    // Generic rule: the admin page is parallel to the SCEP endpoint — 'mscep_admin/' appended to it.
    [InlineData("https://my.server/vscep/", "https://my.server/vscep/mscep_admin/")]
    [InlineData("https://my.server/vscep", "https://my.server/vscep/mscep_admin/")]
    [InlineData("http://localhost:8099/scep", "http://localhost:8099/scep/mscep_admin/")]
    [InlineData("http://localhost:8099/scep/mldsa-rsa", "http://localhost:8099/scep/mldsa-rsa/mscep_admin/")]
