...
public class ProviderLoadTests {
    ...
    public void Loads_provider_by_explicit_path_with_shared_contract() {
        ...
        dll = Path.Combine(AppContext.BaseDirectory, "ScepWright.Crypto.BouncyCastle.dll");
    ...
    public void Missing_impl_reports_no_implementation() {
        ...
        dll = Path.Combine(AppContext.BaseDirectory, "ScepWright.Crypto.dll");
    ...
    private abstract class DummyCryptoBase : IScepCrypto {
        ...
        public bool ExportPkcs12(IScepKey key, System.Security.Cryptography.X509Certificates.X509Certificate2 leaf, System.Collections.Generic.IReadOnlyList<System.Security.Cryptography.X509Certificates.X509Certificate2> chain, string password, bool legacy, out byte[] der, out string error) => throw new NotImplementedException();
    }
