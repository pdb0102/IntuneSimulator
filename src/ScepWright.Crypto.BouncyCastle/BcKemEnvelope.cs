...
internal static class BcKemEnvelope {
    ...
    public static byte[] BuildCbc(byte[] plaintext, MLKemPublicKeyParameters recipient_public, byte[] recipient_key_id, string content_cipher_oid) {
        SecureRandom random;
        byte[] cek;
        byte[] iv;
    ...
    internal static byte[] Decrypt(byte[] der, MLKemPrivateKeyParameters recipient_private) {
    ...
    internal static byte[] EncryptGcm(byte[] plaintext, MLKemPublicKeyParameters recipient_public, byte[] recipient_key_id) {
        SecureRandom random;
        byte[] cek;
        byte[] nonce;
