...
/// <summary>A single algorithm registry entry: its canonical name, OID, and kind.</summary>
public sealed record AlgorithmEntry(string Name, string Oid, AlgorithmKind Kind);

/// <summary>Registry mapping algorithm names to OIDs and kinds for the algorithms the suite knows about.</summary>
public static class Algorithms {
    private static readonly AlgorithmEntry[] Entries =
    {
        ...
        new("SHA-384",     "2.16.840.1.101.3.4.2.2",        AlgorithmKind.Digest),
        ...
        new("EC",          "1.2.840.10045.2.1",             AlgorithmKind.AsymmetricKey),
    ...
    /// <summary>Returns the OID for the given algorithm name, or null if unknown. Case-insensitive.</summary>
    public static string? OidFor(string name) => ByName.TryGetValue(name, out AlgorithmEntry? e) ? e.Oid : null;

    /// <summary>Returns the canonical algorithm name for the given OID, or null if unknown.</summary>
    public static string? NameFor(string oid) => ByOid.TryGetValue(oid, out AlgorithmEntry? e) ? e.Name : null;

    /// <summary>Returns the kind of algorithm for the given OID, or null if unknown.</summary>
