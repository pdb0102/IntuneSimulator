...
/// <summary>Maps the behavior-control endpoints used to read and mutate simulator settings, drive the failure flow, and inspect recorded requests.</summary>
public static class ControlEndpoints
{
    private static readonly JsonSerializerOptions _indented = new() { WriteIndented = true };

    /// <summary>Maps the control endpoints onto the application.</summary>
