...
/// <summary>Maps the simulated Intune SCEP action endpoints (request validation, success and failure notifications).</summary>
public static class ScepEndpoints
{
    /// <summary>Maps the SCEP action endpoints onto the application.</summary>
