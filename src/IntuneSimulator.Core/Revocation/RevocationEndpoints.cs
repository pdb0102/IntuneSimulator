...
/// <summary>Maps the simulated certificate-authority revocation endpoints (download revocation requests and upload revocation results).</summary>
public static class RevocationEndpoints
{
    /// <summary>Maps the revocation endpoints onto the application.</summary>
