...
/// <summary>Middleware that injects the failure-flow engine's current fault into matching requests before they reach their handler.</summary>
public sealed class FailureFlowMiddleware
{
    ...
    /// <summary>Identifies the request, asks the engine whether to inject a fault, and either injects it or passes the request through.</summary>
