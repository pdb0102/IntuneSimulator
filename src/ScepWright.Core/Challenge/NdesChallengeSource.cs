...
/// <summary>Obtains a one-time challenge password by scraping the Microsoft NDES mscep_admin page.</summary>
public sealed class NdesChallengeSource : IChallengeSource {
    ...
    /// <summary>Creates a source that fetches the NDES admin page at <paramref name="admin_url"/> with Basic auth.</summary>
