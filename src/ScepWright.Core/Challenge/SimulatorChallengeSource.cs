...
/// <summary>Obtains a challenge password from the IntuneSimulator's <c>/challenge</c> endpoint.</summary>
public sealed class SimulatorChallengeSource : IChallengeSource {
    private readonly HttpClient _http;
    private readonly string _base_url;

    /// <summary>Creates a source targeting the simulator at <paramref name="base_url"/>.</summary>
